...
def test_partial_data():
    ...
    mock_sql_results = [("8-10", "0.8-1.0", 50), ("0-2", "0-0.2", 10)]
    ...
    high_risk_cell = next(
        cell
        for cell in grid
        if cell["cvss_range"] == "8-10" and cell["epss_range"] == "0.8-1.0"
    )
    low_risk_cell = next(
        cell
        for cell in grid
        if cell["cvss_range"] == "0-2" and cell["epss_range"] == "0-0.2"
    )
    ...
    empty_cell_1 = next(
        cell
        for cell in grid
        if cell["cvss_range"] == "4-6" and cell["epss_range"] == "0.4-0.6"
    )
    empty_cell_2 = next(
        cell
        for cell in grid
        if cell["cvss_range"] == "4-6" and cell["epss_range"] == "0-0.2"
    )
    empty_cell_3 = next(
        cell
        for cell in grid
        if cell["cvss_range"] == "2-4" and cell["epss_range"] == "0.8-1.0"
    )
